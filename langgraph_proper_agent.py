...
class XLSFormProperAgent:
    ...
    def __init__(self, xml_file_path: str):
        ...
        self.model = ChatOpenAI(model="gpt-3.5-turbo").bind_tools(self.tools)
    ...
    def _create_tools(self):
        ...
        def add_choice_options_batch(list_name: str, items_csv: str, worksheet: str = None) -> str:
            ...
            try:
                ...
                if result.get("modified"):
                    ...
                    return json.dumps({"success": True, "added": result.get("added"), "failed": result.get("failed"), "modified_file_path": output_path}, indent=2)
                else:
        ...
        def add_row_auto(target_sheet_hint: str, row_values_csv: str) -> str:
            ...
            try:
                ...
                if result.get("success"):
                    ...
                    return json.dumps({"success": True, "worksheet": result.get("worksheet"), "modified_file_path": out}, indent=2)
        ...
        return [add_choice_option_to_list, add_choice_options_batch, add_row_auto, create_task_plan, execute_task_plan, analyze_form_structure]
