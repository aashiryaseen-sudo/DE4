...
class XLSFormXMLEditor:
    ...
    def add_row_to_best_match(self, row_values: List[str], sheet_hint: Optional[str] = None) -> Dict[str, Any]:
        ...
        for ws in self._iter_worksheets():
            ...
            keywords = {"form_title","form_id","style","version","run_diagnostic","send_reports","integration","label","name","list name","list_name"}
    ...
    def add_choice_options_batch(self, list_name: str, items: List[Dict[str, str]], worksheet_name: str = None) -> Dict[str, Any]:
        ...
        try:
            if operation_type == 'remove':
                ...
                if target_sheet and target_field:
                    ...
                    result['message'] = f"Removed {removed_count} fields matching '{target_field}' from '{target_sheet}'"
                ...
                if target_sheet and target_field:
                    ...
                    if new_value:
                        ...
                        result['message'] = f"Modified {modified_count} instances of '{target_field}' in '{target_sheet}'"
                    else:
